...
#Edited by: Charnyl adaro
#Facebook: https://facebook.com/charnyladaro
#Github: https://github.com/chappie2610
...
def check_connection(host='https://www.google.com'):
	print("{}Verifying your internet connection...".format(GREEN))
	time.sleep(0.5)
	try:
		...
		print("{0}[x]:{1} Verify your internet connection.".format(RED, DEFAULT))
		exit(0)
...
def info():
	...
	time.sleep(0.5)
	print("{0}[AUTHOR]:{1} CharnylAdaro\n\n".format(RED, DEFAULT))
	time.sleep(0.5)
	print("{0}[GITHUB]:{1} https://github.com/chappie2610\n\n".format(RED, DEFAULT))
	time.sleep(0.5)
	print("{0}[FACEBOOK]:{1} https://www.facebook.com/charnyladaro\n\n".format(RED, DEFAULT))
	time.sleep(0.5)
	os.system('clear')
...
def main():
	...
	if option == '01':
		...
		print ('{0}03){1} Spade               {2}Python script to generate a backdoor to any APK.'.format(WHITE, YELLOW, DEFAULT))
		...
		print ('{0}08){1} Android-Exploits    {2}Android exploits and hacks collection.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}09){1} Grabcam             {2}Allows to hack our victims camera with a fake page.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}10){1} Androidpatternlock  {2}Allows to obtain the lock pattern on Android devices.'.format(WHITE, YELLOW, DEFAULT))
		...
		os.system('clear')
		print ('========{0}Tool{1}================================================{0}Information{1}==================================='.format(GREEN, DEFAULT))
		print ('{0}01){1} Winpayloads             {2}Generator of undetectable payloads in Windows.'.format(WHITE, YELLOW, DEFAULT))
		...
		print ('{0}05){1} Koadic                  {2}Windows Rootkit after an exploit.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}06){1} Phantom Evasion         {2}Antivirus evasion tool.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}07){1} Ps1encode               {2}Payload generator and encoder based on PowerShell.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}08){1} DKMC                    {2}Malicious payload avoidance tool.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}09){1} Cromos                  {2}Inject code into legitimate Chrome Web extensions.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}10){1} Eternal_scanner         {2}Scanner for Eternal Blue and Eternal Romance exploits.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}11){1} EternalblueDoublepulsar {2}Metasploit module to exploit Eternalblue-Doublepulsar vulnerability.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}12){1} EternalBlueWinXPWin10   {2}Metasploit EternalBlue module from Windows XP SP2 to Windows 10 Pro.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}13){1} Windows-Exploits        {2}CWindows Exploit Collection.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0} 0){1} Back'.format(WHITE, YELLOW))
		...
		print ('{0}03){1} SocialPhish  {2}Phishing tool with 32 templates + 1 customizable one.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}04){1} SocialFish   {2}Educational phishing tool.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}05){1} PhisherMan   {2}Phishing tool with 17 templates and functional with ngrok.'.format(WHITE, YELLOW, DEFAULT))
		...
		print ('{0}08){1} PhEmail      {2}Automates the process of sending phishing emails.'.format(WHITE, YELLOW, DEFAULT))
		...
		print ('{0}02){1} Wifiphisher    {2}tool that allows capturing wifi passwords via AP.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}03){1} Wifibroot      {2}Pentest Cracking wifi tool for WPA/WPA2.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}04){1} Wifite         {2}Runs existing wireless auditing tools for you.'.format(WHITE, YELLOW, DEFAULT))
		...
		print ('{0}09){1} Evil Limiter   {2}Tool to limit the bandwidth of the devices.'.format(WHITE, YELLOW, DEFAULT))					
		...
		print ('{0}14){1} Eaphammer      {2}Kit for targeted attacks against WPA2-Enterprise networks.'.format(WHITE, YELLOW, DEFAULT))				
		print ('{0}15){1} VMR-MDK        {2}Script to decrypt WPS wireless networks.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}16){1} Wirespy        {2}Allows you to set up fast honeypots to carry out MITMA.'.format(WHITE, YELLOW, DEFAULT))						
		print ('{0}17){1} Wireshark      {2}Network analyzer that allows you to capture and navigate the network traffic..'.format(WHITE, YELLOW, DEFAULT))						
		print ('{0}18){1} SniffAir       {2}Framework for wireless pentesting.'.format(WHITE, YELLOW, DEFAULT))
		print ('{0}19){1} WifiJammer     {2}Continuously jams all wif clients/routersi.'.format(WHITE, YELLOW, DEFAULT))						
